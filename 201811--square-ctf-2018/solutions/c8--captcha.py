...
# r = rq.get("https://hidden-island-93990.squarectf.com/ea6c95c6d0ff24545cad")
# html = str(r.content)
...
# for k in symbol2name:
#     print(chr(k), name2value[symbol2name[k]])
...
result = eval(plain)
os.system('echo ' + '%d' % result + ' | xclip -selection clipboard ')
# r = rq.post("https://hidden-island-93990.squarectf.com/ea6c95c6d0ff24545cad", {"answer":"12"})
# print(r.text)
